...
<body>
	...
	<a href="?id=${gpuMemoryTechnology.id }&language=en">English</a>|
	<a href="?id=${gpuMemoryTechnology.id }&language=al">Albanian</a>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" method="POST"
			modelAttribute="gpuMemoryTechnology" enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="updateGpuMemoryTechnology.form.legend" /> ${gpuMemoryTechnology.name}
				</legend> 
					...
					<div class="col-lg-10">
						...
						<c:if test="${param.error != null}">
							<span style="color: red;"><spring:message
									code="addGpuMemoryTechnology.form.name.error" /></span>
						</c:if>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="image"> <spring:message
							code="addGpuMemoryTechnology.form.image.label" />
					</label>
