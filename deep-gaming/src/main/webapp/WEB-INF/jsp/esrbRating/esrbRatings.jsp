...
<body>
	...
	<section>
		<div
			...
			<spring:message code="esrbRatings.legend" />
		</div>
	</section>
	<div class="col-md-12">
		<div class="row">
			<div class="products-tabs">
				...
				<div id="tab2" class="tab-pane fade in active">
					...
					<div class="products-slick" data-nav="#slick-nav-2">
						<c:forEach items="${esrbRatings}" var="esrbRating">
								...
								<div class="product-body">
									...
									<h2 class="product-name">
										<a style="font-size: 20px;"
											href="<spring:url value="/esrbRating/details?id=${esrbRating.id}" />">${esrbRating.name}</a>
									</h2>
