...
<body>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" method="POST"
			modelAttribute="esrbRating" enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="updateEsrbRating.form.legend" /> ${esrbRating.name}
				</legend> 
					...
					<div class="col-lg-10">
						...
						<c:if test="${param.error != null}">
							<span style="color: red;"><spring:message
									code="addEsrbRating.form.name.error" /></span>
						</c:if>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="image"> <spring:message
							code="addEsrbRating.form.image.label" />
					</label>
