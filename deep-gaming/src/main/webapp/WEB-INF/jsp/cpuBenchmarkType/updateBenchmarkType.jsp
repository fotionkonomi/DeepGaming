		...
		<form:form class="form-horizontal" method="POST"
			...
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="updateCpuBenchmarkType.form.legend" /> ${benchmarkType.name}
				</legend> 
					...
					<div class="col-lg-10">
						...
						<c:if test="${param.error != null}">
							<span style="color: red;"><spring:message
									code="addCpuBenchmarkType.form.name.error" /></span>
						</c:if>
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="image"> <spring:message
							code="addCpuBenchmarkType.form.image.label" />
					</label>
