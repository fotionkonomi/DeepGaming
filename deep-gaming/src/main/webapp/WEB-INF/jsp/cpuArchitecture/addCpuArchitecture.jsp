...
<body>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" commandName="newCpuArchitecture"
			method="POST" modelAttribute="newCpuArchitecture"
			enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="addCpuArchitecture.form.legend" />
				</legend>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<form:errors path="companyOfThisCpuArchitecture" cssClass="text-danger" />
