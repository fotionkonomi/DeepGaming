...
<body>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" method="POST"
			modelAttribute="gpuFamily" enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="updateGpuFamily.form.legend" /> ${gpuFamily.name}
				</legend> 
					...
					<div class="col-lg-10">
						...
						<c:if test="${param.error != null}">
							<span style="color: red;"><spring:message
									code="addGpuFamily.form.name.error" /></span>
						</c:if>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2"><spring:message
							code="addGpuFamily.form.company.label" /></label>
					<div class="col-lg-10">
						<form:select path="companyOfThisGpuFamily" class="form-control">
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="image"> <spring:message
							code="addGpuFamily.form.image.label" />
					</label>
