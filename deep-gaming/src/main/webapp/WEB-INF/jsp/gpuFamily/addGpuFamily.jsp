...
<body>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" commandName="newGpuFamily"
			method="POST" modelAttribute="newGpuFamily"
			enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="addGpuFamily.form.legend" />
				</legend>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						...
						<form:errors path="companyOfThisGpuFamily" cssClass="text-danger" />
