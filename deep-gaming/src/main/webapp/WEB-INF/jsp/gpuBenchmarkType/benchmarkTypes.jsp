...
<body>
	...
	<section>
		<div
			...
			<spring:message code="gpuBenchmarkTypes.legend" />
		</div>
	</section>
	<div class="col-md-12">
		<div class="row">
							...
							<div class="product">
								<div class="product-img">
									<img width="420px" height="240px"
										src="<c:url value="/img/gpubenchmarktype${benchmarkType.id}.png">
 </c:url>"
								...
								<div class="product-body">
									...
									<h2 class="product-name">
										<a style="font-size: 20px;"
											href="<spring:url value="/gpuBenchmarkType/details?id=${benchmarkType.id}" />">
