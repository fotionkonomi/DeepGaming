...
<body>
	...
	<a
		href="?id=${gpu.id }&language=en">English</a>|
	<a
		href="?id=${gpu.id }&language=al">Albanian</a>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" method="POST"
			modelAttribute="gpu" enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="updateGpu.form.legend" />
				</legend>
