...
<body>
	...
	<section class="container">
		<form:form method="POST" modelAttribute="newEsrb">
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="name" path="esrbRatingName" type="text"
				...
				<div class="form-group">
					...
					<div class="col-lg-10">
						<form:input id="description" path="esrbRatingDescription" type="text"
							class="form:input-large" />
