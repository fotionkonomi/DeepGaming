...
<body>
	...
	<section>
		<div
			...
			<spring:message code="cpuFamilies.legend" />
		</div>
	</section>
	<div class="col-md-12">
		<div class="row">
								...
								<div class="product-body">
									...
									<h2 class="product-name">
										<a style="font-size: 20px;"
											href="<spring:url value="/cpuFamily/details?id=${cpuFamily.id}" />">${cpuFamily.companyOfThisCpuFamily.name}
											${cpuFamily.name}</a>
									</h2>
	...
	<c:if test="${not empty companies}">
		...
		<section>
			<div
				style="text-align: center; color: black; padding-top: 20px; font-size: 20px;">
				<spring:message code="cpuFamilies.company.legend" />
			</div>
		</section>
		<div class="col-md-12">
			<div class="row">
							...
							<c:forEach items="${companies}" var="company">
								...
								<div class="product">
									...
									<div class="product-body">
										...
										<h2 class="product-name">
											<a style="font-size: 20px;"
												href="<spring:url value="/cpuFamily/cpuFamilies/${company.name} " />">
												${company.name}</a>
										</h2>
