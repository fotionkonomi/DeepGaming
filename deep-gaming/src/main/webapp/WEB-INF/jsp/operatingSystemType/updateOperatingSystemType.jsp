...
<body>
	...
	<section class="container">
		...
		<form:form class="form-horizontal" method="POST"
			modelAttribute="operatingSystemType" enctype="multipart/form-data">
			<fieldset>
				<legend style="padding-top: 20px; font-size: 37px;">
					<spring:message code="updateOperatingSystemType.form.legend" />
					...
					<div class="col-lg-10">
						...
						<c:if test="${param.error != null}">
							<span style="color: red;"><spring:message
									code="addOperatingSystemType.form.name.error" /></span>
						</c:if>
				...
				<div class="form-group">
					<label class="control-label col-lg-2 col-lg-2"><spring:message
							code="addOperatingSystemType.form.company.label" /></label>
					<div class="col-lg-10">
						<form:select path="companyOfThisOS" class="form-control">
							<form:options items="${allCompanies}" />
						</form:select>
						<form:errors path="companyOfThisOS" cssClass="text-danger" />
				...
				<div class="form-group">
					<label class="control-label col-lg-2" for="image"> <spring:message
							code="addOperatingSystemType.form.image.label" />
					</label>
