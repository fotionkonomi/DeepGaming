...
public class CpuSocketConverter implements Converter {
	...
	public IModel toModel(IDto dtoObject) {
		if (dtoObject.getClass() != CpuSocketDTO.class) {
			LOGGER.log(Level.SEVERE, "Dto object of class " + dtoObject.getClass().getName()
					+ " cannot be converted to an object of the type " + CpuSocket.class.getName());
			return null;
		} else {
	...
	public IDto toDTO(IModel modelObject) {
		if (modelObject.getClass() != CpuSocket.class) {
			LOGGER.log(Level.SEVERE, "Model object of class " + modelObject.getClass().getName()
					+ " cannot be converted to an object of the type " + CpuSocketDTO.class.getName());
			return null;
		} else {
