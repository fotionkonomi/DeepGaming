 ...
 create table motherboard (maximum_ram_capacity double precision not null, maximum_ram_speed integer not null, id_product integer not null, id_company integer not null, id_cpu_socket integer not null, id_motherboard_form_factor integer not null, primary key (id_product)) ;
 ...
 alter table product add column id_product_type int not null;
alter table product add constraint FK_p8jrh60mfpaarkvabx9arihk5lp foreign key (id_product_type) references product_type (id_product_type);
